...
<svg class="figure fig-ohm" data-foc="${focus}" viewBox="0 0 320 200" role="img" aria-label="Circuit électrique">
  <!-- fil (boucle) -->
  <path class="fil" data-etape="1" d="M60 40 H260 Q280 40 280 60 V140 Q280 160 260 160 H60 Q40 160 40 140 V60 Q40 40 60 40 Z"
        fill="none" stroke="#8fa6c4" stroke-width="5" stroke-linejoin="round"/>
  <g data-etape="3">${charges}</g>
  <!-- pile (pompe) à gauche -->
  <g class="part part-U" data-etape="2">
  ...
  <g class="part part-R" data-etape="4">
  ...
  <g class="part part-I" data-etape="3">
  ...
  <!-- loi -->
  <text class="loi" data-etape="5" x="160" y="104" text-anchor="middle">U = R × I</text>
</svg>`;
}
...
<svg class="figure fig-vitesse" data-foc="${focus}" viewBox="0 0 320 200" role="img" aria-label="Mobile en mouvement">
  <!-- piste -->
  <line data-etape="1" x1="24" y1="150" x2="296" y2="150" stroke="#8fa6c4" stroke-width="4"/>
  <g class="part part-d" data-etape="2">
  ...
  <!-- horloge (temps) -->
  <g class="part part-t" data-etape="3" transform="translate(272 44)">
  ...
  <!-- loi -->
  <text class="loi" data-etape="4" x="150" y="60" text-anchor="middle">v = d / t</text>
</svg>`;
}
...
function figPoids(focus) {
  ...
  <g class="astre ${cls}" transform="translate(${cx} 0)">
    <text class="astre-nom" data-etape="1" x="0" y="34" text-anchor="middle">${nom}</text>
    <!-- objet (masse identique) -->
    <rect class="objet part part-masse" data-etape="1" x="-22" y="60" width="44" height="34" rx="6" fill="#f5b400" stroke="#c8902c" stroke-width="2"/>
    <text class="objet-m" data-etape="1" x="0" y="82" text-anchor="middle">m</text>
    <!-- flèche du poids -->
    <path class="poids-fleche part part-poids" data-etape="3" d="M0 100 v ${long} m0 0 l-7 -9 m7 9 l7 -9" fill="none" stroke="#ff5d7d" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
    <text class="lab-g part part-astre" data-etape="2" x="0" y="${112 + long + 16}" text-anchor="middle">${g}</text>
  </g>`;
  return `
<svg class="figure fig-poids" data-foc="${focus}" viewBox="0 0 320 200" role="img" aria-label="Poids sur la Terre et la Lune">
  ...
  <line data-etape="1" x1="160" y1="20" x2="160" y2="180" stroke="#2a3f56" stroke-width="1.5" stroke-dasharray="4 5"/>
  <text class="loi" data-etape="4" x="160" y="196" text-anchor="middle">P = m × g</text>
</svg>`;
}
...
<svg class="figure fig-matiere" data-foc="${focus}" viewBox="0 0 320 200" role="img" aria-label="Masse volumique d’un bloc">
  ...
  <g data-etape="1" transform="translate(96 66)">
  ...
  <g class="part part-masse" data-etape="2">
  ...
  <!-- repère volume -->
  <g class="part part-volume" data-etape="3">
  ...
  <text class="loi" data-etape="4" x="248" y="104" text-anchor="middle">ρ = m / V</text>
</svg>`;
}
...
<svg class="figure fig-etats" data-foc="${focus}" viewBox="0 0 300 200" role="img" aria-label="Les états de la matière">
  <g data-etape="1">${bac(48)}${grille(48, 66)}<text class="astre-nom" x="48" y="112" text-anchor="middle">solide</text></g>
  <g data-etape="2">${bac(132)}${tas(132, 74)}<text class="astre-nom" x="132" y="112" text-anchor="middle">liquide</text></g>
  <g data-etape="3">${bac(216)}${gaz(216, 64)}<text class="astre-nom" x="216" y="112" text-anchor="middle">gaz</text></g>
  <g class="part part-changements" data-etape="4">
...
<svg class="figure fig-energie" data-foc="${focus}" viewBox="0 0 320 200" role="img" aria-label="Puissance électrique">
  <path class="fil" data-etape="1" d="M70 46 H250 Q268 46 268 64 V138 Q268 156 250 156 H70 Q52 156 52 138 V64 Q52 46 70 46 Z"
        fill="none" stroke="#8fa6c4" stroke-width="5" stroke-linejoin="round"/>
  <g data-etape="3">${charges}</g>
  ...
  <g class="part part-P" data-etape="4">
  ...
  <text class="loi" data-etape="5" x="120" y="104" text-anchor="middle">P = U × I</text>
</svg>`;
}
...
<svg class="figure fig-signaux" data-foc="${focus}" viewBox="0 0 320 200" role="img" aria-label="Propagation d’un signal">
  ...
  <g data-etape="1">${ondes}</g>
  <!-- récepteur : oreille -->
  <path data-etape="2" d="M262 78 q22 0 22 26 q0 18 -14 20 q-8 1 -8 10" fill="none" stroke="#c3ccd8" stroke-width="5" stroke-linecap="round"/>
  <!-- distance d -->
  <g class="part part-d" data-etape="3">
  ...
  <!-- temps t -->
  <g class="part part-t" data-etape="4" transform="translate(280 42)">
  ...
  <text class="loi" data-etape="5" x="160" y="46" text-anchor="middle">v = d / t</text>
</svg>`;
}
